...
export default function TransactionsPage() {
  ...
  const removeCoolingItem = (id) =>
    setCoolingItems((prev) => prev.filter((i) => i.id !== id));
  ...
  const subscriptions = transactions.filter(
    (t) =>
      ...
      (t.category === "Entertainment" ||
        t.notes.toLowerCase().includes("netflix") ||
        t.notes.toLowerCase().includes("spotify") ||
        t.amount === 45.99),
  );
            ...
            >
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="magic" className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-primary" /> Magic Add
                </TabsTrigger>
              ...
              <TabsContent value="magic" className="space-y-4 pt-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    The AI Co-Pilot will automatically extract the amount,
                    category, and notes.
                  </p>
                </div>
                ...
                <Button
                  ...
                  disabled={isParsing}
                  className="w-full text-foreground/80 flex gap-2 border-dashed"
                >
                  <Camera className="w-4 h-4" />{" "}
                  {isParsing
                    ? "Scanning Receipt Vision..."
                    : "Scan physical receipt (AI Vision)"}
                </Button>
                <Button
              ...
              filtered.map((t) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center text-lg ${t.type === "income" ? "bg-success/10" : "bg-destructive/10"}`}
                    >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {t.account} · {t.date} {t.notes && `· ${t.notes}`}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-card rounded-xl card-shadow p-5">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                We found recurring payments that look like subscriptions. Review
                them to stop money leaks.
              </p>
                  ...
                  >
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-muted-foreground">
                        Appears to be bi-weekly or monthly
                      </span>
                    </div>
            ...
            <div className="bg-card rounded-xl card-shadow p-5 border border-primary/20 bg-primary/5">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Impulse buy? Put it in the drawer. We lock the 'Purchase' button
                for 48 hours to help you reconsider.
              </p>
              ...
              <div className="flex gap-2 mb-4">
                ...
                <Input
                  ...
                  className="w-24"
                  value={coolAmount}
                  onChange={(e) => setCoolAmount(e.target.value)}
                />
              ...
              <div className="space-y-3">
                {coolingItems.map((item) => {
                  const hoursPassed =
                    (Date.now() - item.timestamp) / (1000 * 60 * 60);
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {isUnlocked
                            ? "Cooling period over. Still want it?"
                            : `Locked: ${hoursLeft} hours remaining`}
                        </span>
                      </div>
                      {isUnlocked ? (
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() => removeCoolingItem(item.id)}
                          >
                            Discard
                          </Button>
                          <Button
                        ...
                        <div
                          className="p-2 bg-muted rounded-md tooltip"
                          title={`Unlocks in ${hoursLeft} hours`}
                        >
