...
export default function SimulatorPage() {
  // What-If State
  const [scenarioType, setScenarioType] = useState("invest");
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Project your financial future and explore how different decisions
          impact your goals.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-1 border-primary/20 bg-primary/5">
              <CardHeader>
                ...
                <CardDescription>
                  Adjust the variables to simulate your net worth.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      variant={
                        scenarioType === "invest" ? "default" : "outline"
                      }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="flex flex-col items-center justify-center space-y-4 p-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
              ...
              <div className="text-center">
                ...
                <p className="text-4xl font-bold mt-2 text-primary">
                  ${monthlyRoundup.toFixed(2)}
                </p>
                <p className="text-sm text-muted-foreground mt-2">
                  from spare change on everyday purchases
                </p>
              </div>
            </Card>
            ...
            <Card className="md:col-span-2 shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  See how small change adds up over a year without you even
                  noticing.
                </CardDescription>
              </CardHeader>
              <CardContent>
