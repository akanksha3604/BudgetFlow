    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Alert className="bg-destructive/10 border-destructive/20 text-destructive relative overflow-hidden">
          ...
          <AlertDescription className="text-destructive/90 text-sm mt-1">
            You are spending $45/day in <strong>Food & Dining</strong>. At this
            velocity, you will overdraw your checking account before your next
        ...
        <Alert className="bg-primary/5 border-primary/20 text-primary relative overflow-hidden">
          ...
          <AlertDescription className="text-muted-foreground text-sm mt-1">
            You consistently underspend your{" "}
            <span className="font-medium text-foreground">Entertainment</span>{" "}
            budget by $60. Want to seamlessly re-allocate this to{" "}
            <span className="font-medium text-foreground">Groceries</span> where
            you typically overspend?
            <Button
              variant="outline"
              size="sm"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {mockBudgets.map((b) => {
          ...
          const status =
            pct >= 100 ? "exceeded" : pct >= 80 ? "warning" : "safe";
          const barColor =
            status === "exceeded"
              ? "bg-destructive"
              : status === "warning"
            ...
            <div key={b.id} className="bg-card rounded-xl card-shadow p-5">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-muted-foreground">
                  ...
                  <span
                    className={`font-medium ${remaining >= 0 ? "text-success" : "text-destructive"}`}
                  >
